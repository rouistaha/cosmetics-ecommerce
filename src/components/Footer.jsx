      ...
      <div className="container">
        <div ref={ref} className={`footer-top reveal ${isVisible ? 'is-visible' : ''}`}>
          <div className="footer-brand">
            <h2>RADIANT</h2>
            <p>Elevating reality through cosmetic engineering.</p>
          ...
          <div className="footer-newsletter">
            <h4>The List</h4>
            <p>Receive classified transmissions and early access to new artifacts.</p>
        ...
        <div className="footer-bottom">
          <p>&copy; {new Date().getFullYear()} RADIANT LABS. ALL RIGHTS RESERVED.</p>
